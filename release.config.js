...
./gradlew publishAndroidSemanticVersionPublicationToMavenRepository -PsigningKey="$SIGNING_KEY" -PsigningPassword="$SIGNING_PASSWORD" -PmavenCentralPwd="$MAVEN_PASSWORD" -PmavenCentralUser="$MAVEN_USER" || exit 3
